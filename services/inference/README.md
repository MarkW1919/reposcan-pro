...
- promoted ONNX bundle assembly from exported per-stage ONNX artifacts
...
- repo-tracked fixture bundles and baseline evidence reports for the closed Section 4 runtime checklist items
